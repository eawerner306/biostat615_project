...
# ISTA_lassosolve <- function(X, y, lambda, max_iter = 1000, tol = 1e-6) {
#   # ISTA_lasso: Implementation of the ISTA algorithm for Lasso regression
#   #
#   # Args:
...
#   # Returns:
#   #   A list containing:
#   #     - beta: Coefficients including the intercept term
#   #     - iter: Number of iterations performed
...
#       # Calculate intercept
#       intercept <- y_mean - sum(X_mean * beta_new)
#       full_beta <- c(intercept, beta_new)
#       return(list(beta = full_beta, iter = iter, convergence = TRUE))
#     }
